...
class SimpleKeyTeleop():
    def __init__(self, interface):
        ...
        self._forward_rate = rospy.get_param('~forward_rate', 2.0)
        self._backward_rate = rospy.get_param('~backward_rate', 2.0)
        self._rotation_rate = rospy.get_param('~rotation_rate', 2.0)
